...
CREATE TABLE IF NOT EXISTS `db_blogpessoal`.`tb_postagem` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_postagem_tb_usuarios_idx` (`tb_usuarios_id` ASC) VISIBLE,
  INDEX `fk_tb_postagem_tb_tema1_idx` (`tb_tema_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_postagem_tb_usuarios`
...
-- -----------------------------------------------------
-- Table `db_blogpessoal`.`tb_usuarioLogin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_blogpessoal`.`tb_usuarioLogin` (
  `id` BIGINT NOT NULL,
  `nome` VARCHAR(255) NOT NULL,
  `usuario` VARCHAR(255) NOT NULL,
  `senha` VARCHAR(255) NOT NULL,
